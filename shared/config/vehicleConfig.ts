...
export const VEHICLE_CONFIG: Record<VehicleType, VehicleDefinition> = {
  taxi: {
    ...
    gemCost: 1_000,
    accentColor: '#E5A72E',
    iconAsset: require('../../assets/img/TaxiIcon.png'),
  ...
  forklift: {
    ...
    gemCost: 1_000,
    accentColor: '#3FA535',
    iconAsset: require('../../assets/img/ForkliftIcon.png'),
  ...
  armored_truck: {
    ...
    gemCost: 2_500,
    accentColor: '#9A6FD0',
    iconAsset: require('../../assets/img/ArmoredtruckIcon.png'),
  ...
  delivery_truck: {
    ...
    gemCost: 1_000,
    accentColor: '#3376E5',
    iconAsset: require('../../assets/img/DeliverytruckIcon.png'),
  ...
  bus: {
    ...
    gemCost: 1_000,
    accentColor: '#E05A4A',
    iconAsset: require('../../assets/img/BusIcon.png'),
