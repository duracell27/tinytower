...
export const GameStateSchema = z.object({
  ...
  coinBoostPercent:   z.number().int().min(0).max(300).default(0),
  xpBoostPercent:     z.number().int().min(0).max(300).default(0),
  coinBoostExpiresAt: z.number().nonnegative().default(0),
  xpBoostExpiresAt:   z.number().nonnegative().default(0),
