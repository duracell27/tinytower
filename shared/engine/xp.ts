...
export function xpForCommand(
  ...
  if (cmdType === 'buy_floor' || cmdType === 'exchange_gems' || cmdType === 'speed_up_construction' || cmdType === 'claim_daily_task' || cmdType === 'claim_tutorial_task' || cmdType === 'claim_tutorial_final') return 0;
