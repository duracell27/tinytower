...
export function loadGameState(): PersistedGameState | null {
  ...
  try {
    ...
    const withDefaults = {
      ...
      dailyTipsStage1Claimed: parsed.dailyTipsStage1Claimed ?? parsed.dailyTipsRewardClaimed ?? false,
      dailyTipsStage2Claimed: parsed.dailyTipsStage2Claimed ?? false,
...
export function saveGameState(state: PersistedGameState): void {
  ...
  s.set(GAME_STATE_KEY, JSON.stringify({
    ...
    dailyTipsStage1Claimed: state.dailyTipsStage1Claimed ?? false,
