...
const ALLOWED_DYNAMIC_CHROME_PREFIXES = ['roles.', 'jobPicker.matchBadges.', 'tools.', 'workersPanel.tabs.', 'myBusiness.categories.', 'myBusiness.tokenLabels.', 'deliverAll.rows.vip_', 'city.roles.'];
