...
export class SyncService {
      ...
      await this.prisma.$transaction(async (tx) => {
        ...
        await tx.playerState.upsert({
          ...
          create: {
            ...
            warehouseLevel: gameState.warehouseLevel ?? 0,
            ...
            wood:  gameState.tools.wood,
            cement: gameState.tools.cement,
            ...
            businessUpgradeGreen:   gameState.businessUpgrades.green,
            businessUpgradeBlue:    gameState.businessUpgrades.blue,
            ...
            coinBoostExpiresAt: BigInt(Math.round(gameState.coinBoostExpiresAt ?? 0)),
            xpBoostExpiresAt:   BigInt(Math.round(gameState.xpBoostExpiresAt   ?? 0)),
  ...
  private dbToGameState(player: any): GameState {
    ...
    return {
      ...
      warehouseLevel: s?.warehouseLevel ?? 0,
      ...
      businessUpgrades: {
        green:  s?.businessUpgradeGreen  ?? 0,
        blue:   s?.businessUpgradeBlue   ?? 0,
        yellow: s?.businessUpgradeYellow ?? 0,
        purple: s?.businessUpgradePurple ?? 0,
